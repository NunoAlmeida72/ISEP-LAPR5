...
export const playerData = {
    //url: "assets/models/delivery_rover.glb",
...
export const doorData = {
    url:  "./assets/textures/door/minecraft_wooden_door.glb",
    credits: "'Minecraft Wooden Door' (https://skfb.ly/6zpqC) by Blender3D is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).",
    scale: new THREE.Vector3(0.5, 0.5, 0.5),
}

export const elevatorData = {
    url:  "./assets/models/elevator/elevator-door.glb",
    credits: "By 1-3D.com (https://sketchfab.com/1-3D.com",
