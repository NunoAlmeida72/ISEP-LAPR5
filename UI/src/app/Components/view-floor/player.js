    ...
    constructor(parameters) {
        ...
        this.onLoad = function (description) {
            ...
            /*
                ...
                If we want to change the player model, we need to account for the realistic mode camera position and orientation.
                Also new models won't have things like world position and world scale, so we need to compute them.
